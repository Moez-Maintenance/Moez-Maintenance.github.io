...
/* harmony import */ var _guards_guard_admin_guard__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./guards/guard-admin.guard */ "./src/app/guards/guard-admin.guard.ts");
...
const routes = [
    ...
    { path: 'list', component: _list_list_component__WEBPACK_IMPORTED_MODULE_3__["ListComponent"], canActivate: [_guards_guard_admin_guard__WEBPACK_IMPORTED_MODULE_5__["GuardAdminGuard"]] },
    {
...
/* harmony import */ var _voiture_service__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./voiture.service */ "./src/app/voiture.service.ts");
...
AppModule.ɵinj = _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵdefineInjector"]({ factory: function AppModule_Factory(t) { return new (t || AppModule)(); }, providers: [_voiture_service__WEBPACK_IMPORTED_MODULE_3__["VoitureService"]], imports: [[_angular_platform_browser__WEBPACK_IMPORTED_MODULE_0__["BrowserModule"], _angular_common_http__WEBPACK_IMPORTED_MODULE_4__["HttpClientModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_5__["FormsModule"], _app_routing_module__WEBPACK_IMPORTED_MODULE_7__["AppRoutingModule"]]] });
(function () { (typeof ngJitMode === "undefined" || ngJitMode) && _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵsetNgModuleScope"](AppModule, { declarations: [_app_component__WEBPACK_IMPORTED_MODULE_2__["AppComponent"], _view_view_component__WEBPACK_IMPORTED_MODULE_6__["ViewComponent"], _list_list_component__WEBPACK_IMPORTED_MODULE_8__["ListComponent"], _login_login_component__WEBPACK_IMPORTED_MODULE_9__["LoginComponent"]], imports: [_angular_platform_browser__WEBPACK_IMPORTED_MODULE_0__["BrowserModule"], _angular_common_http__WEBPACK_IMPORTED_MODULE_4__["HttpClientModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_5__["FormsModule"], _app_routing_module__WEBPACK_IMPORTED_MODULE_7__["AppRoutingModule"]] }); })();
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "GuardAdminGuard", function() { return GuardAdminGuard; });
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/__ivy_ngcc__/fesm2015/core.js");
/* harmony import */ var _angular_router__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/router */ "./node_modules/@angular/router/__ivy_ngcc__/fesm2015/router.js");
/* harmony import */ var _voiture_service__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./../voiture.service */ "./src/app/voiture.service.ts");




class GuardAdminGuard {
    constructor(router, share) {
        this.router = router;
        this.share = share;
    }
...
GuardAdminGuard.ɵfac = function GuardAdminGuard_Factory(t) { return new (t || GuardAdminGuard)(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵinject"](_angular_router__WEBPACK_IMPORTED_MODULE_1__["Router"]), _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵinject"](_voiture_service__WEBPACK_IMPORTED_MODULE_2__["VoitureService"])); };
GuardAdminGuard.ɵprov = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineInjectable"]({ token: GuardAdminGuard, factory: GuardAdminGuard.ɵfac, providedIn: 'root' });
/*@__PURE__*/ (function () { _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](GuardAdminGuard, [{
        type: _angular_core__WEBPACK_IMPORTED_MODULE_0__["Injectable"],
        args: [{
                providedIn: 'root',
            }]
    }], function () { return [{ type: _angular_router__WEBPACK_IMPORTED_MODULE_1__["Router"] }, { type: _voiture_service__WEBPACK_IMPORTED_MODULE_2__["VoitureService"] }]; }, null); })();
...
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/__ivy_ngcc__/fesm2015/core.js");
/* harmony import */ var _voiture_service__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../voiture.service */ "./src/app/voiture.service.ts");
...
const _c0 = function (a1) { return ["/list/view/", a1]; };
function ListComponent_tr_34_Template(rf, ctx) { if (rf & 1) {
    ...
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function ListComponent_tr_34_Template_button_click_20_listener() { _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵrestoreView"](_r7); const voiture_r5 = ctx.$implicit; const ctx_r6 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵnextContext"](); return ctx_r6.onOpenModal(voiture_r5, "edit"); });
    ...
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function ListComponent_tr_34_Template_button_click_22_listener() { _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵrestoreView"](_r7); const voiture_r5 = ctx.$implicit; const ctx_r8 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵnextContext"](); return ctx_r8.onOpenModal(voiture_r5, "delete"); });
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtext"](23, " X ");
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();
} if (rf & 2) {
    const voiture_r5 = ctx.$implicit;
...
function ListComponent_div_144_Template(rf, ctx) { if (rf & 1) {
...
class ListComponent {
    ...
    getVoitures() {
        this.voitureService.getVoitures().subscribe((response) => {
    ...
    onAddVoiture(addForm) {
        document.getElementById('add-voiture-form').click();
        this.voitureService.addVoiture(addForm.value).subscribe((response) => {
    ...
    onUpdateVoiture(voiture) {
        this.voitureService.updateVoiture(voiture).subscribe((response) => {
            console.log(response);
            this.getVoitures();
        }, (error) => {
            alert(error.message);
    ...
    onDeleteVoiture(voitureId) {
        this.voitureService.deleteVoiture(voitureId).subscribe((response) => {
            console.log(response);
            this.getVoitures();
        }, (error) => {
            alert(error.message);
    ...
    searchVoitures(key) {
        ...
        for (const voiture of this.voitures) {
            if (voiture.client.toLowerCase().indexOf(key.toLowerCase()) !== -1 ||
...
ListComponent.ɵfac = function ListComponent_Factory(t) { return new (t || ListComponent)(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](_voiture_service__WEBPACK_IMPORTED_MODULE_1__["VoitureService"])); };
ListComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({ type: ListComponent, selectors: [["app-list"]], decls: 145, vars: 14, consts: [[1, "navbar", "navbar-expand-lg", "navbar-dark", "bg-dark"], [1, "navbar-brand", 2, "color", "white"], ["id", "navbarColor02", 1, "collapse", "navbar-collapse"], [1, "navbar-nav", "mr-auto"], [1, "nav-item", "active"], [1, "nav-link", 3, "click"], [1, "sr-only"], [1, "form-inline", "my-2", "my-lg-0"], ["type", "search", "ngModel", "", "name", "key", "id", "searchName", "placeholder", "Chercher voitures...", "required", "", 1, "form-control", "mr-sm-2", 3, "ngModelChange"], ["key", "ngModel"], ["id", "main-container", 1, "container"], [1, "table", "table-bordered"], ["width", "220px"], [4, "ngFor", "ngForOf"], ["id", "addVoitureModal", "tabindex", "-1", "role", "dialog", "aria-labelledby", "addVoitureModalLabel", "aria-hidden", "true", 1, "modal", "fade"], ["role", "document", 1, "modal-dialog"], [1, "modal-content"], [1, "modal-header"], ["id", "addVoitureModalLabel", 1, "modal-title"], ["type", "button", "data-dismiss", "modal", "aria-label", "Close", 1, "close"], ["aria-hidden", "true"], [1, "modal-body"], [3, "ngSubmit"], ["addForm", "ngForm"], [1, "form-group"], ["for", "client"], ["type", "text", "ngModel", "", "name", "client", "id", "client", "placeholder", "Client", "required", "", 1, "form-control"], ["for", "marque"], ["type", "text", "ngModel", "", "name", "marque", "id", "marque", "placeholder", "Marque", "required", "", 1, "form-control"], ["for", "kilometrage"], ["type", "text", "ngModel", "", "name", "kilometrage", "id", "kilometrage", "placeholder", "Kilom\u00E9trage", "required", "", 1, "form-control"], ["for", "matricule"], ["type", "text", "ngModel", "", "name", "matricule", "id", "matricule", "placeholder", "Matricule", "required", "", 1, "form-control"], ["for", "commentaire"], ["type", "text", "ngModel", "", "name", "commentaire", "id", "commentaire", "placeholder", "Commentaires", "required", "", 1, "form-control"], ["type", "text", "ngModel", "", "name", "numTelephone", "id", "numTelephone", "placeholder", "T\u00E9l\u00E9phone", "required", "", 1, "form-control"], ["for", "total"], ["type", "number", "ngModel", "", "name", "total", "id", "total", "placeholder", "Reste \u00E0 Payer", "required", "", 1, "form-control"], [1, "modal-footer"], ["type", "button", "id", "add-voiture-form", "data-dismiss", "modal", 1, "btn", "btn-secondary"], ["type", "submit", 1, "btn", "btn-primary", 3, "disabled"], ["id", "updateVoitureModal", "tabindex", "-1", "role", "dialog", "aria-labelledby", "voitureEditModalLabel", "aria-hidden", "true", 1, "modal", "fade"], ["id", "updateVoitureModalLabel", 1, "modal-title"], ["editForm", "ngForm"], ["type", "text", "name", "client", "id", "client", "aria-describedby", "emailHelp", "placeholder", "Client", 1, "form-control", 3, "ngModel"], ["type", "hidden", "name", "id", "id", "id", 1, "form-control", 3, "ngModel"], ["type", "hidden", "name", "date", "id", "date", 1, "form-control", 3, "ngModel"], ["type", "text", "name", "marque", "id", "marque", "placeholder", "Marque", 1, "form-control", 3, "ngModel"], ["type", "text", "name", "kilometrage", "id", "kilometrage", "placeholder", "Kilom\u00E9trage", 1, "form-control", 3, "ngModel"], ["type", "text", "name", "matricule", "id", "matricule", "name", "matricule", "placeholder", "Matricule", 1, "form-control", 3, "ngModel"], ["type", "text", "name", "commentaire", "id", "commentaire", "name", "commentaire", "placeholder", "Commentaires", 1, "form-control", 3, "ngModel"], ["for", "numTelepone"], ["type", "text", "name", "numTelephone", "id", "numTelephone", "name", "numTelephone", "placeholder", "T\u00E9l\u00E9phone", 1, "form-control", 3, "ngModel"], ["type", "number", "name", "total", "id", "total", "name", "total", "placeholder", "Reste \u00E0 payer", 1, "form-control", 3, "ngModel"], ["type", "button", "id", "", "data-dismiss", "modal", 1, "btn", "btn-secondary"], ["data-dismiss", "modal", 1, "btn", "btn-primary", 3, "click"], ["id", "deleteVoitureModal", "tabindex", "-1", "role", "dialog", "aria-labelledby", "deleteModelLabel", "aria-hidden", "true", 1, "modal", "fade"], ["id", "deleteModelLabel", 1, "modal-title"], ["type", "button", "data-dismiss", "modal", 1, "btn", "btn-secondary"], ["data-dismiss", "modal", 1, "btn", "btn-danger", 3, "click"], ["class", "col-lg-12 col-md-12 col-xl-12", 4, "ngIf"], [1, "btn", "btn-info", 3, "routerLink"], [1, "btn", "btn-primary", 3, "click"], ["type", "button", 1, "btn", "btn-danger", 3, "click"], [1, "col-lg-12", "col-md-12", "col-xl-12"], ["role", "alert", 1, "alert", "alert-info"], [1, "alert-heading"]], template: function ListComponent_Template(rf, ctx) { if (rf & 1) {
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function ListComponent_Template_a_click_6_listener() { return ctx.onOpenModal(null, "add"); });
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("ngModelChange", function ListComponent_Template_input_ngModelChange_11_listener() { _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵrestoreView"](_r9); const _r0 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵreference"](12); return ctx.searchVoitures(_r0.value); });
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtext"](23, "Kilom\u00E9trage");
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtext"](31, "Reste \u00E0 payer");
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("ngSubmit", function ListComponent_Template_form_ngSubmit_45_listener() { _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵrestoreView"](_r9); const _r2 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵreference"](46); return ctx.onAddVoiture(_r2); });
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtext"](57, "Kilom\u00E9trage");
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtext"](69, "T\u00E9l\u00E9phone");
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtext"](73, "Reste \u00E0 Payer");
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtext"](104, "Kilom\u00E9trage");
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtext"](116, "T\u00E9l\u00E9phone");
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtext"](120, "Reste \u00E0 payer");
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function ListComponent_Template_button_click_125_listener() { _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵrestoreView"](_r9); const _r3 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵreference"](91); return ctx.onUpdateVoiture(_r3.value); });
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function ListComponent_Template_button_click_142_listener() { return ctx.onDeleteVoiture(ctx.deleteVoiture == null ? null : ctx.deleteVoiture.id); });
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtextInterpolate1"](" Vous \u00EAtes en train de supprimer la voiture ", ctx.deleteVoiture == null ? null : ctx.deleteVoiture.marque, "? ");
...
/*@__PURE__*/ (function () { _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](ListComponent, [{
    ...
    }], function () { return [{ type: _voiture_service__WEBPACK_IMPORTED_MODULE_1__["VoitureService"] }]; }, null); })();
...
class LoginComponent {
    constructor(router, voitureService) {
        this.router = router;
        this.voitureService = voitureService;
    }
    ngOnInit() { }
...
LoginComponent.ɵfac = function LoginComponent_Factory(t) { return new (t || LoginComponent)(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](_angular_router__WEBPACK_IMPORTED_MODULE_1__["Router"]), _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](_voiture_service__WEBPACK_IMPORTED_MODULE_2__["VoitureService"])); };
LoginComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({ type: LoginComponent, selectors: [["app-login"]], decls: 18, vars: 6, consts: [["id", "container", 1, "container"], [1, "form-container", "log-in-container"], ["action", "#"], ["type", "text", "placeholder", "Username", 3, "ngModel", "ngModelOptions", "ngModelChange"], ["type", "password", "placeholder", "Password", 3, "ngModel", "ngModelOptions", "ngModelChange"], ["type", "button", 3, "click"], [1, "overlay-container"], [1, "overlay"], [1, "overlay-panel", "overlay-right"]], template: function LoginComponent_Template(rf, ctx) { if (rf & 1) {
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function LoginComponent_Template_button_click_9_listener() { return ctx.loginCheck(); });
...
class ViewComponent {
    constructor(voitureService, route) {
        this.voitureService = voitureService;
        this.route = route;
    }
    ngOnInit() {
...
ViewComponent.ɵfac = function ViewComponent_Factory(t) { return new (t || ViewComponent)(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](_voiture_service__WEBPACK_IMPORTED_MODULE_1__["VoitureService"]), _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](_angular_router__WEBPACK_IMPORTED_MODULE_2__["ActivatedRoute"])); };
ViewComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({ type: ViewComponent, selectors: [["app-view"]], decls: 58, vars: 8, consts: [[1, "navbar", "navbar-expand-lg", "navbar-dark", "bg-dark"], [1, "navbar-brand", 2, "color", "white"], [1, "container"], ["routerLink", "/list", 1, "btn", "btn-primary"]], template: function ViewComponent_Template(rf, ctx) { if (rf & 1) {
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "nav", 0);
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](1, "a", 1);
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtext"](2, "Maintenance Chez Moez");
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtext"](55, "Reste \u00E0 Payer : ");
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();
...
/*@__PURE__*/ (function () { _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](ViewComponent, [{
    ...
    }], function () { return [{ type: _voiture_service__WEBPACK_IMPORTED_MODULE_1__["VoitureService"] }, { type: _angular_router__WEBPACK_IMPORTED_MODULE_2__["ActivatedRoute"] }]; }, null); })();
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "VoitureService", function() { return VoitureService; });
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/__ivy_ngcc__/fesm2015/core.js");
...
class VoitureService {
    ...
    getVoitures() {
        return this.http.get(`${this.apiServerUrl}/voiture/all`);
    }
    addVoiture(voiture) {
        return this.http.post(`${this.apiServerUrl}/voiture/add`, voiture);
    }
    updateVoiture(voiture) {
        return this.http.put(`${this.apiServerUrl}/voiture/update`, voiture);
    }
    findVoiture(voitureId) {
        return this.http.get(`${this.apiServerUrl}/voiture/find/${voitureId}`);
    }
    deleteVoiture(voitureId) {
        return this.http.delete(`${this.apiServerUrl}/voiture/delete/${voitureId}`);
    }
}
VoitureService.ɵfac = function VoitureService_Factory(t) { return new (t || VoitureService)(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵinject"](_angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpClient"])); };
VoitureService.ɵprov = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineInjectable"]({ token: VoitureService, factory: VoitureService.ɵfac, providedIn: 'root' });
/*@__PURE__*/ (function () { _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](VoitureService, [{
        type: _angular_core__WEBPACK_IMPORTED_MODULE_0__["Injectable"],
...
module.exports = __webpack_require__(/*! C:\Users\Mr_GaDouR\Desktop\moez\maintenanceVoitureApp\src\main.ts */"./src/main.ts");
